# 1 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
# 2 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 3 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
...
# 18 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 19 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 20 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 21 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 22 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 23 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 24 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 25 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
# 26 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 2
...
double Irms0 = 0.00;
double Irms1 = 0.00;
Button2 buttonA = Button2(35 /*| interupt Defual reset*/);
...
void setup()
{
  ...
  LEDon[1] = 22;
  tft.init();
  tft.fillScreen(0xF800 /* 255,   0,   0 */);
  tft.fillScreen(0xFFFF /* 255, 255, 255 */);
  tft.setTextColor(0x0000 /*   0,   0,   0 */, 0xFFFF /* 255, 255, 255 */);
  pinMode(LEDon[0], 0x02);
  pinMode(LEDon[1], 0x02);
  pinMode(13, 0x01); // input down = master
  EEPROMwifi();
  readeepromnode();
  buttonResetDefault();
...
# 169 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
       __null
# 169 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
...
# 179 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
       __null
# 179 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
           , /* parameter of the task */
        9, /* priority of the task */
...
# 192 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
     __null
# 192 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
         , /* parameter of the task */
...
void serverpagePV(void *pvParameters)
{
  while (1)
  {
    ...
    if (down_time > 3000)
    {
      ...
      vTaskDelete(
# 233 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
                 __null
# 233 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
                     );
    }
    if (setupserver == true)
    {
...
{ //Server Recive
  ...
  if (obj.containsKey("IDnodename"))
  {
    if (String("MyClient").equals(obj["IDnodename"].as<String>()))
    {
      ...
      */
# 300 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
...
{ //Client Recive
  ...
  { // topic = Find serverID
    if (String("MyServer").equals(obj["topic"].as<String>()))
    {
      ...
      if (timenow == timeON0) ///LED 0 ON
      {
        if (Led0Status() == "false")
        {
          if (digitalRead(LEDon[0]) == 0x0)
            digitalWrite(LEDon[0], 0x1);
          else if (digitalRead(LEDon[0]) == 0x1)
            digitalWrite(LEDon[0], 0x0);
        }
      }
      if (timenow == timeON1) ///LED 1 ON
      {
        if (Led1Status() == "false")
        {
          if (digitalRead(LEDon[1]) == 0x0)
            digitalWrite(LEDon[1], 0x1);
          else if (digitalRead(LEDon[1]) == 0x1)
            digitalWrite(LEDon[1], 0x0);
        }
      }
  ...
  { //CMD = controlnode
    ...
    if (String("ControlLAMP").equals(obj["Status"].as<String>()))
    {
      ...
      if (digitalRead(LEDon[ARGname.toInt()]) == 0x0)
        digitalWrite(LEDon[ARGname.toInt()], 0x1);
      else if (digitalRead(LEDon[ARGname.toInt()]) == 0x1)
        digitalWrite(LEDon[ARGname.toInt()], 0x0);
    ...
    if (String("TimeLamp").equals(obj["Status"].as<String>()))
    {
      ...
      */
# 515 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
      if (LAMP0 == 1 && TurnOn == 1)
...
String Led0Status()
{
  return (PINCHECKstatus0 == 0x0) ? "false" : "true";
}

String Led1Status()
{
  return (PINCHECKstatus1 == 0x0) ? "false" : "true";
}
...
void HandleOnOff(AsyncWebServerRequest *request)
{
  ...
  for (int i = 0; i < args; i++)
  {
    if ((request->argName(i) == ("LED" + poiter + "arg")))
    {
      ...
      if (digitalRead(LEDon[poiter.toInt()]) == 0x0)
        digitalWrite(LEDon[poiter.toInt()], 0x1);
      else if (digitalRead(LEDon[poiter.toInt()]) == 0x1)
        digitalWrite(LEDon[poiter.toInt()], 0x0);
...
void MeshServersetup()
{
  ...
  mesh.init(MESH_PREFIX, MESH_PASSWORD, &userScheduler, MESH_PORT, WIFI_MODE_APSTA, 6);
...
# 759 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
     __null
# 759 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
         , /* parameter of the task */
...
void asyncPV(void *pvParameters)
{
  ...
  setupserver = true;
  vTaskDelete(
# 908 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
             __null
# 908 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
                 );
}
...
void PVlogServerTask(void *pvParameters)
{
  while (1)
  {
    ...
    if (setupserver == true)
    {
      ...
      {
        vTaskDelete(
# 985 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino" 3 4
                   __null
# 985 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
                       );
      }
...
void vwifiscana(AsyncWebServerRequest *request)
{
  ...
  Serial.print(((reinterpret_cast<const __FlashStringHelper *>(("Connect Mode Connecting to ")))));
...
void vlampcontrolnode(AsyncWebServerRequest *request)
{
  ...
  */
# 1229 "c:\\Users\\chinz\\Documents\\testENDproject\\testENDproject.ino"
  if (statz == 1)
  {
    DynamicJsonDocument jsonBuffer(256);
    JsonObject msg = jsonBuffer.to<JsonObject>();
...
void vlampallnode(AsyncWebServerRequest *request)
{
  ...
  else if (request->hasArg("LED1arg"))
  {
    ...
    String msg = "{\"CMD\":\"ServerCMD\",\"Status\":\"ControlLAMP\",\"ARGname\":\"LED1arg\",\"ARGstat\":\"" + stats + "\"}";
    if (stats == "true")
    {
